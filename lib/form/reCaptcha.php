	...
	namespace bmca\form{
		...
		class reCaptcha{
			...
			public function __construct($siteKey, $secret){
				$this->SITE_KEY = new \bmca\container\ConstString($siteKey);
				$this->SECRET = new \bmca\container\ConstString($secret);
			}
			...
			public function checkResponse(){
				...
				if(isset($_POST['g-recaptcha-response'])){
					...
					$recaptcha = new \ReCaptcha\ReCaptcha($this->SECRET->value());
			...
			public function getHTML(){
				return '
				<div class="g-recaptcha" data-sitekey="'.$this->SITE_KEY->value().'"></div>
